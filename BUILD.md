...
الأمر بيجيب لوحده كل النسخ اللي اتبنت وكل النسخ اللي اتبعتلها تحديثات قبل
كده، وبيبعت لكلهم.

**ولو عايز تضيف نسخة معينة بنفسك**، اكتب رقمها في الآخر:

```bash
npm run send-update "وصف التعديل" 0.25.0
```
